      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="/superadmin/mutasi/aviasi" class="nav-link active" style="background-color: #9cc5f0;">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Aviasi</p>
                </a>
              </li>
                                  ...
                                  <div class="modal-dialog modal-dialog-centered" role="document">
                                      <div class="modal-content">
                                          ...
                                          <div class="modal-footer">
                                              ...
                                              <form action="/superadmin/mutasi/aviasi/{{ $d->id }}" method="post"
                                                  class="d-inline">
                                                  @method('delete')
                                                  @csrf
                      ...
                      <div class="modal fade" id="modal-edit-{{ $d->id }}" tabindex="-1" aria-labelledby="titleModalLabel" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                            <form action="/superadmin/mutasi/aviasi/{{ $d->id }}" name="modal_popup" enctype="multipart/form-data" method="post">
                                    @method('PUT')
                                    @csrf
                                    ...
                                    @error('name') style="border: 1px solid rgb(255, 0, 0)" @enderror>
                                      ...
                                      value= "{{ old('name') !== null ?  old('name') : "$d->name" }}" readonly>
                                      <span class="text-danger">
                                        @error('name')
                                          {{ $message }}
                                        @enderror
    ...
    <div class="modal fade" id="ModalAdd" tabindex="-1" aria-labelledby="titleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
						<form action="/superadmin/mutasi/aviasi" name="modal_popup" enctype="multipart/form-data" method="post">
                    @csrf
                    <div class="form-group"  
                    @error('date') style="border: 1px solid rgb(255, 0, 0)" @enderror>

      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="/superadmin/pembelian/aviasi" class="nav-link active" style="background-color: #9cc5f0;">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Aviasi</p>
                </a>
              </li>
  ...
  <div class="content-wrapper">
      ...
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <i class="fas fa-clipboard-check"></i>
            <span>Data Pembelian Barang Aviasi</span></h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
                    ...
                    <tr>
                                  ...
                                  <div class="modal-dialog modal-dialog-centered" role="document">
                                      <div class="modal-content">
                                          ...
                                          <div class="modal-footer">
                                              ...
                                              <form action="/superadmin/pembelian/aviasi/{{ $d->id }}" method="post"
                                                  class="d-inline">
                                                  @method('delete')
                                                  @csrf
                      ...
                      <div class="modal fade" id="modal-edit-{{ $d->id }}" tabindex="-1" aria-labelledby="titleModalLabel" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="titleModalLabel">Edit Data Pembelian Barang Aviasi</h5>
                                    <button type="button" class="close" data-dismiss="modal"
                                                                  aria-label="Close">
                                                                  <span aria-hidden="true">&times;</span>
                                                              </button>
                                ...
                                <div class="modal-body">
                            <form action="/superadmin/pembelian/aviasi/{{ $d->id }}" name="modal_popup" enctype="multipart/form-data" method="post">
                                    @method('PUT')
                                    @csrf
                                    ...
                                    @error('price_per_item') style="border: 1px solid rgb(255, 0, 0)" @enderror>
                                      <label for="price"><span class="fas fa-money-bill-alt"></span> Harga Satuan</label>
                                      <input type="number" min="1000" class="form-control" id="price_per_item" name="price_per_item" placeholder="Masukkan harga satuan" 
                                      value="{{ old('price_per_item') !== null ?  old('price_per_item') : "$d->price_per_item" }}" >
                                      <span class="text-danger">
                                    ...
                                    @error('price') style="border: 1px solid rgb(255, 0, 0)" @enderror>
                                      <label for="price"><span class="fas fa-money-bill-alt"></span> Total Harga</label>
                                      <input type="number" min="1000" class="form-control" id="price" name="price" placeholder="Masukkan total harga" 
    ...
    <div class="modal fade" id="ModalAdd" tabindex="-1" aria-labelledby="titleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="titleModalLabel">Tambah Data Pembelian Barang Aviasi</h5>
                    <button type="button" class="close" data-dismiss="modal"
                                                  aria-label="Close">
                                                  <span aria-hidden="true">&times;</span>
                                              </button>
                ...
                <div class="modal-body">
						<form action="/superadmin/pembelian/aviasi" name="modal_popup" enctype="multipart/form-data" method="post">
                    @csrf
                    <div class="form-group"  
                    @error('date') style="border: 1px solid rgb(255, 0, 0)" @enderror>

...
class DataMgPurchaseController extends Controller
{
    public function index()
    {
        return view('superadmin.migas-purchase', [
    ...
    public function store(Request $request){
        ...
        if ($validator->fails()){
            return redirect('/superadmin/pembelian/migas')->with('error', 'Input data gagal mohon periksa kembali.')
        ...
        return redirect('/superadmin/pembelian/migas')->with('success', 'Data berhasil ditambahkan');
    }
    ...
    public function update(Request $request, MigasPurchase $purchase){
        ...
        return redirect('/superadmin/pembelian/migas')->with('success', 'Data berhasil di update');
    }
    ...
    public function destroy(MigasPurchase $purchase, Request $request){
        ...
        return redirect('/superadmin/pembelian/migas')->with('success', 'Data berhasil dihapus');
    }

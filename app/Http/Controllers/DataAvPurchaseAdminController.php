...
class DataAvPurchaseAdminController extends Controller
{
    public function index()
    {
        return view('admin.aviasi-purchase', [
    ...
    public function store(Request $request){
        ...
        if ($validator->fails()){
            return redirect('/admin/pembelian/aviasi')->with('error', 'Input data gagal, mohon periksa kembali.')
    ...
    public function destroy(AviasiPurchase $purchase, Request $request){
       ...
       AviasiPurchase::destroy($purchase->id);
        ...
        return redirect('/admin/pembelian/aviasi')->with('success', 'Data berhasil dihapus');
    }

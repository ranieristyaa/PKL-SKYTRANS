...
class DataAvRentalController extends Controller
{
    ...
    public function store(Request $request){
        ...
        if ($validator->fails()){
            return redirect('/superadmin/rental')->with('error', 'Input data gagal, mohon periksa kembali.')
        ...
        return redirect('/superadmin/rental')->with('success', 'Data berhasil ditambahkan');
    }
    ...
    public function update(Request $request, AviasiRental $rental){
        ...
        return redirect('/superadmin/rental')->with('success', 'Data berhasil diupdate');
    }
    ...
    public function destroy(AviasiRental $rental){
        ...
        return redirect('/superadmin/rental')->with('success', 'Data berhasil dihapus');
    }
}
